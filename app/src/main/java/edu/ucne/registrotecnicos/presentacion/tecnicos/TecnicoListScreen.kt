...
fun TecnicoListScreenPreview() {
    val sampleTecnicos = remember {
        mutableStateListOf(
            TecnicoEntity(tecnicoId = 1, nombre = "Juan Pérez", sueldo = 25000.0),
            TecnicoEntity(tecnicoId = 2, nombre = "María García", sueldo = 28000.0),
            TecnicoEntity(tecnicoId = 3, nombre = "Carlos López", sueldo = 32000.0)
        )
    }
    ...
    TecnicoListScreen(
        ...
        onCreate = { sampleTecnicos.add(TecnicoEntity(tecnicoId = 1,nombre = "Nuevo Técnico", sueldo = 30000.0)) },
