    ...
    fun TecnicoScreen(
        ...
        Scaffold { innerPadding ->
            Column(
                ...
                TecnicosListScreen(ticketList)
            }
        }
    }

    @Composable
    fun TecnicosListScreen(tecnicoList: List<TecnicoEntity>) {
        Column(
            modifier = Modifier.fillMaxSize()
        ) {
            Spacer(modifier = Modifier.height(32.dp))
            Text("Lista de tecnico")
    ...
    fun Preview() {
        RegistroTecnicosTheme {
            val tecnicoList = listOf(
                TecnicoEntity(1, "Alma ", "5,000"),
                TecnicoEntity(2, "Juan", "1000"),
            )
            TecnicosListScreen(tecnicoList)
        }
    }
}